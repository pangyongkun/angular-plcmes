...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
    return {
        restrict: 'EA',
        template: '<div class="page-list" align="center">' +
        ...
        '第<input type="text" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)" class="text-center"/>页 ' +
        ...
        link: function (scope, element, attrs) {
            ...
            function getPagination(newValue, oldValue) {
                ...
                if (scope.conf.onChange) {
                    ...
                    var notDel = newValue.split(' ')[0] == oldValue.split(' ')[0];
