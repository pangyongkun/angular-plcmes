...
(function () {
    ...
    angular.module('raw-material-processing.FA.stock')
        .controller('FAStockListCtrl', stockList)
        .controller('FAStockDetailCtrl', stockDetail);


    stockList.$inject = ['FAStockService', 'progress', 'ConfirmDialog', 'notify', '$state', '$stateParams'];
    ...
    stockDetail.$inject = ['FAStockService', 'progress', '$timeout'];
