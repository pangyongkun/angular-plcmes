...
(function () {
    ...
    angular.module('raw-material-processing.FA.stock-out')
        .controller('FAStockOutListCtrl', stockOutList)
        .controller('FAStockOutAddCtrl', stockOutAdd)
        .controller('FAStockOutMergeCtrl', stockOutMerge);


    stockOutList.$inject = ['FAStockOutService', 'progress', 'ConfirmDialog', 'notify', '$state', '$stateParams'];
    ...
    stockOutAdd.$inject = ['FAStockOutService', '$state', '$stateParams', 'progress', 'notify'];
    ...
    stockOutMerge.$inject = ['FAStockOutService', 'FAStockOutPrepService', '$state', 'notify', 'progress'];
