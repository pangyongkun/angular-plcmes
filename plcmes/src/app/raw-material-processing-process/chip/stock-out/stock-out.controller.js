...
(function () {
    ...
    angular.module('raw-material-processing.FA.stock-out')
        .controller('ChipStockOutListCtrl', stockOutList)
        .controller('ChipStockOutAddCtrl', stockOutAdd)
        .controller('ChipStockOutMergeCtrl', stockOutMerge);


    stockOutList.$inject = ['ChipStockOutService', 'progress', 'ConfirmDialog', 'notify', '$state', '$stateParams'];
    ...
    stockOutAdd.$inject = ['ChipStockOutService', '$state', '$stateParams', 'progress', 'notify'];
    ...
    stockOutMerge.$inject = ['ChipStockOutService', 'ChipStockOutPrepService', '$state', 'notify', 'progress'];
