...
(function () {
    ...
    angular.module('raw-material-processing.chip.stock-in')
        .controller('SFStockInListCtrl', stockInList)
        .controller('SFStockInAddCtrl', stockInAdd)
        .controller('SFStockInMergeCtrl', stockInMerge);


    stockInList.$inject = ['SFStockInService', 'progress', 'ConfirmDialog', 'notify', '$state', '$stateParams'];
    ...
    stockInAdd.$inject = ['SFStockInService', '$state', '$stateParams', 'progress', 'notify'];
    ...
    stockInMerge.$inject = ['SFStockInServiceF', 'SFStockInPrepService', '$state', 'notify', 'progress'];
